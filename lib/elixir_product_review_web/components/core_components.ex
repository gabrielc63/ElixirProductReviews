defmodule ElixirProductReviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirProductReviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirProductReviewWeb.Gettext, "errors", msg, opts)
    end
  end

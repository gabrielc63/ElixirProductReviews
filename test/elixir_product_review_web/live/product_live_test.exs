defmodule ElixirProductReviewWeb.ProductLiveTest do
  use ElixirProductReviewWeb.ConnCase

  import Phoenix.LiveViewTest
  import ElixirProductReview.ProductsFixtures

  @create_attrs %{description: "some description", image_url: "some image_url", name: "some name", overall_rating: 42}
